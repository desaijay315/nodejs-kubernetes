$(document).ready(function () {
  ...
  $(".showModal").click(function (e) {
    ...
    $("#video_modal iframe").attr("src", videosrcauto); //$("#myModal").modal("show");
  });
  ...
  var thinkingOffset = $('.fwd_thinking_section').offset().top; // tab underline start
  ...
  changePos(); // Tabs click

  $('.as').on('click', function (e) {
    e.preventDefault(); // Tab Id

    var tabId = $(this).attr('tab-id'); // Remove Active State

    $('.tabs-header a').stop().parent().removeClass('active'); // Add Active State
