...
$(document).ready(function () {
  ...
  for (var _i = 0; _i < links_partners.length; _i++) {
    if (document.readyState !== 'loading') {
      links_partners[_i].addEventListener("click", mouseenterFunc2);
    } else {
      links_partners[_i].addEventListener("click", mouseenterFunc2);
    }
  }
  ...
  function mouseenterFunc() {
    for (var _i2 = 0; _i2 < links.length; _i2++) {
      if (links[_i2].parentNode.classList.contains("active")) {
        links[_i2].parentNode.classList.remove("active");
      }
    }
  ...
  function mouseenterFunc2() {
    for (var _i3 = 0; _i3 < links_partners.length; _i3++) {
      if (links_partners[_i3].parentNode.classList.contains("active")) {
        links_partners[_i3].parentNode.classList.remove("active");
    ...
    var top2 = this.offsetTop; //var color = colors[Math.floor(Math.random() * colors.length)];

    target2.style.width = "".concat(width2, "px");
    target2.style.height = "".concat(height2, "px");

    if ($('#scrollNav').length) {
      scrollcontent();
    } else {
      target2.style.left = "".concat(left2, "px");
    }

    target2.style.top = "".concat(top2, "px"); //target.style.borderColor = color;
