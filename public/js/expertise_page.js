...
$(window).scroll(function() {
 ...
 $('.link-start').click(function(){
    ...
    $("html, body").animate({ scrollTop: $(this).closest('.content-block-container').find('.content-main').offset().top - topHeight - 60}, 1000);
    if ($(window).width() < 992) {
        $("html, body").animate({ scrollTop: $(this).closest('.content-block-container').find('.content-main').offset().top - topHeight - 30}, 1000);   
    }
    return false;
 });
