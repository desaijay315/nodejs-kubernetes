   ...
   $(document).ready(function(){
     ...
     $(".showModal").click(function(e) {
      ...
      $(".videoLink").click(function(e) {
        ...
        $('.video_link').attr('data-href', videourl);
        //$("#video_modal").modal("show");
...
if ($(window).width() < 992) {
  ...
  $('#carouselNav li a').click(function(e){
      if($('.listNav').length) {
          e.preventDefault();
          let selCat = $(this).attr('href').replace('#', '');
          showStories(selCat);
      }
  })
      ...
      owl.on('changed.owl.carousel', function(e) {
          ...
          setTimeout(function () {
            //   console.log("here", links);
              var dataHash = $('#successCarousel .owl-item.active').children().data('hash');
            //   console.log($('#carouselNav').find('.' + dataHash).index());
              if(typeof dataHash !== "undefined") {
                  ...
                  $('#scrollNav').animate({scrollLeft: Math.round($('#scrollNav li.active').offset().left - 15)}, 100);  
              }
