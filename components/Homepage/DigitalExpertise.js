...
const DigitalExpertise = (props) =>{
    const {digitalExpertiseData} = props;
    const  {field_component_title, field_tile_component} = digitalExpertiseData;
            ...
            <div className="container-fluid no-gutters">
               <div className="row">
                  <div className="col-md-4 offset-md-4 no-gutters p-0">
                     <h2 className="fadeInUp wow">{field_component_title}</h2>
                  </div>
               </div>
               <div className="row expertiseContain">
                  ...
                  {
                    field_tile_component.map((data, index) =>(
                      <div className="col-md-4 col-6 digitalBdr m-0 p-0" key={index}>
                        <div className={index > 2 ? "digital_box digital_box2 p-4" : "digital_box p-4"}>
                          <h3>{data.field_title}</h3>
                            <div className="mainBox">
                            <p>{data.field_description}</p>
                            <a href={data.field_link_component[0].field_link.uri}>{data.field_link_component[0].field_link.title} <i className="arrow"></i></a>
                          </div>
                        </div>
                    </div>
                    ))
