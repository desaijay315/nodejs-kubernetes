      ...
      <div className="form-wrap">
          ...
          <div className="col-md-6">
            <div className="form-group">
              <input id="sust_name" type="text" className="form-control" name=
              "name" value={name} onChange={e => onChange(e)} required autoComplete="off" />
              <label htmlFor="sust_name">Name<sup>*</sup></label>
          ...
          <div className="col-md-6">
            <div className="form-group">
              <input id="sust_email" type="text" className="form-control" name="email" value={email} onChange={e => onChange(e)} required autoComplete="off" />
              <label htmlFor="sust_email">Work Email<sup>*</sup></label>
              <span className="line"></span>
              {
                emailErrors && 
          ...
          <div className="col-md-6">
            <div className="form-group">
              <input id="sust_phone" type="text" className="form-control" name="phone_number" value={phone_number} required onChange={e => onChange(e)} autoComplete="off" />
              <label htmlFor="sust_phone">Phone<sup>*</sup></label>
              <span className="line"></span>
              {
                phoneNumberErrors && 
          ...
          {/* <div className="col-md-6">
            <div className="form-group">
              <input id="sust_location" type="text" className="form-control" name="location" value={location} onChange={e => onChange(e)} required />
              <label htmlFor="sust_location">Location</label>
              <span className="line"></span>
            </div>
          </div> */}
          ...
          <div className="col-md-6">
            <div className="form-group">
              <input id="sust_designation" type="text" className="form-control" name="designation" value={designation} onChange={e => onChange(e)} autoComplete="off" />
              <label htmlFor="sust_designation">Designation</label>
              <span className="line"></span>
              {
           ...
           <div className="col-md-6">
            <div className="form-group">
              <input id="sust_company" type="text" className="form-control" name="company" value={company} required onChange={e => onChange(e)} autoComplete="off" />
              <label htmlFor="sust_company">Company Name<sup>*</sup></label>
              <span className="line"></span>
              {
          ...
          <div className="col-md-6">
            <div className="form-group">
              <input id="sust_industry" type="text" className="form-control" name="industry" value={industry}  onChange={e => onChange(e)} autoComplete="off" />
              <label htmlFor="sust_industry">Industry</label>
              <span className="line"></span>
              {
          ...
          <div className="col-md-6">
            <div className="form-group">
              <input id="sust_website" type="text" className="form-control" name="website" value={website}  onChange={e => onChange(e)} autoComplete="off" />
              <label htmlFor="sust_website">Website</label>
              <span className="line"></span>
              {
            ...
            <div className="form-group radio-group">
              ...
              <ul className="list-unstyled d-flex flex-wrap ml-0 pl-0">
                <li className="w-50">
                  ...
                  checked={sust_timeline === "2 - 4 Weeks"}
                  />
                  <span>2 - 4 Weeks</span>
                ...
                <li className="w-50">
                    ...
                    <input type="radio" 
                     ...
                     value="4 - 6 Weeks" 
                     onChange={e => onChange(e)} 
                     checked={sust_timeline === "4 - 6 Weeks"}
                  ...
                  <li className="w-50">
                      ...
                      <input type="radio" 
                        ...
                        value="6 - 8 Weeks" 
                        onChange={e => onChange(e)} 
                        checked={sust_timeline === "6 - 8 Weeks"}
                    ...
                    <li className="w-50">
                        ...
                        <input type="radio" 
                          ...
                          value="8+ Weeks" 
                          onChange={e => onChange(e)} 
                          checked={sust_timeline === "8+ Weeks"} /> <span> 8+ Weeks</span></label>
                      </li>
              </ul>
              </div>
          ...
          <div className="col-md-6">
            <div className="form-group">
              <input id="sust_resume" name="filename" value={filename} type="text" className="form-control" onChange={(e) => onChangeFile(e)}/>
              {
              ...
              <label htmlFor="sust_resume">Upload BRD</label>
          ...
          <div className="col-md-6">
              <div className="form-group">
                <textarea id="sust_about" className="form-control" name="wish_message" value={wish_message} onChange={e => onChange(e)} autoComplete="off"></textarea>
                <label htmlFor="sust_about">Tells us about your project</label>
                <span className="line"></span>
                {
