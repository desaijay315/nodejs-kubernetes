      ...
      <div className="form-wrap">
          ...
          <div className="col-md-6">
            <div className="form-group">
              <input id="mkt_name" type="text" className="form-control" name=
              "name" value={name} onChange={e => onChange(e)} required autoComplete="off" />
              <label htmlFor="mkt_name">Name<sup>*</sup></label>
          ...
          <div className="col-md-6">
            <div className="form-group">
              <input id="mkt_email" type="text" className="form-control" name="email" value={email} onChange={e => onChange(e)} required autoComplete="off" />
              <label htmlFor="mkt_email">Work Email<sup>*</sup></label>
              <span className="line"></span>
              {
                emailErrors && 
          ...
          <div className="col-md-6">
            <div className="form-group">
              <input id="mkt_phone" type="text" className="form-control" name="phone_number" value={phone_number} required onChange={e => onChange(e)} autoComplete="off" />
              <label htmlFor="mkt_phone">Phone<sup>*</sup></label>
              <span className="line"></span>
              {
                phoneNumberErrors && 
          ...
          {/* <div className="col-md-6">
            <div className="form-group">
              <input id="mkt_location" type="text" className="form-control" name="location" value={location} onChange={e => onChange(e)} required />
              <label htmlFor="mkt_location">Location</label>
              <span className="line"></span>
            </div>
          </div> */}
          ...
          <div className="col-md-6">
            <div className="form-group">
              <input id="mkt_designation" type="text" className="form-control" name="designation" value={designation} onChange={e => onChange(e)} autoComplete="off" />
              <label htmlFor="mkt_designation">Designation</label>
              <span className="line"></span>
              {
           ...
           <div className="col-md-6">
            <div className="form-group">
              <input id="mkt_company" type="text" className="form-control" name="company" value={company} required onChange={e => onChange(e)} autoComplete="off" />
              <label htmlFor="mkt_company">Company Name<sup>*</sup></label>
              <span className="line"></span>
              {
          ...
          <div className="col-md-6">
            <div className="form-group">
              <input id="mkt_industry" type="text" className="form-control" name="industry" value={industry}  onChange={e => onChange(e)} autoComplete="off" />
              <label htmlFor="mkt_industry">Industry</label>
              <span className="line"></span>
              {
          ...
          <div className="col-md-6">
            <div className="form-group">
              <input id="mkt_website" type="text" className="form-control" name="website" value={website}  onChange={e => onChange(e)} autoComplete="off" />
              <label htmlFor="mkt_website">Website</label>
              <span className="line"></span>
              {
            ...
            <div className="form-group radio-group">
              ...
              <ul className="list-unstyled d-flex flex-wrap ml-0 pl-0">
                <li className="w-50">
                  ...
                  checked={mkt_timeline === "2 - 4 Weeks"}
                  />
                  <span>2 - 4 Weeks</span>
                ...
                <li className="w-50">
                    ...
                    <input type="radio" 
                     ...
                     value="4 - 6 Weeks" 
                     onChange={e => onChange(e)} 
                     checked={mkt_timeline === "4 - 6 Weeks"}
                  ...
                  <li className="w-50">
                      ...
                      <input type="radio" 
                        ...
                        value="6 - 8 Weeks" 
                        onChange={e => onChange(e)} 
                        checked={mkt_timeline === "6 - 8 Weeks"}
                    ...
                    <li className="w-50">
                        ...
                        <input type="radio" 
                          ...
                          value="8+ Weeks" 
                          onChange={e => onChange(e)} 
                          checked={mkt_timeline === "8+ Weeks"} /> <span> 8+ Weeks</span></label>
                      </li>
              </ul>
              </div>
          ...
          <div className="col-md-6">
            <div className="form-group">
              <input id="mkt_resume" name="filename" value={filename} type="text" className="form-control" onChange={(e) => onChangeFile(e)}/>
              {
              ...
              <label htmlFor="mkt_resume">Upload BRD</label>
          ...
          <div className="col-md-6">
              <div className="form-group">
                <textarea id="mkt_about" className="form-control" name="wish_message" value={wish_message} onChange={e => onChange(e)} autoComplete="off"></textarea>
                <label htmlFor="mkt_about">Tells us about your project</label>
                <span className="line"></span>
                {
