      ...
      <div className="form-wrap">
          ...
          <div className="col-md-6">
            <div className="form-group">
              <input id="pl_name" type="text" className="form-control" name=
              "name" value={name} onChange={e => onChange(e)} required autoComplete="off" />
              <label htmlFor="pl_name">Name<sup>*</sup></label>
          ...
          <div className="col-md-6">
            <div className="form-group">
              <input id="pl_email" type="text" className="form-control" name="email" value={email} onChange={e => onChange(e)} required autoComplete="off" />
              <label htmlFor="pl_email">Work Email<sup>*</sup></label>
              <span className="line"></span>
              {
                emailErrors && 
          ...
          <div className="col-md-6">
            <div className="form-group">
              <input id="pl_phone" type="text" className="form-control" name="phone_number" value={phone_number} required onChange={e => onChange(e)} autoComplete="off" />
              <label htmlFor="pl_phone">Phone<sup>*</sup></label>
              <span className="line"></span>
              {
                phoneNumberErrors && 
          ...
          {/* <div className="col-md-6">
            <div className="form-group">
              <input id="pl_location" type="text" className="form-control" name="location" value={location} onChange={e => onChange(e)} required />
              <label htmlFor="pl_location">Location</label>
              <span className="line"></span>
            </div>
          </div> */}
          ...
          <div className="col-md-6">
            <div className="form-group">
              <input id="pl_designation" type="text" className="form-control" name="designation" value={designation} onChange={e => onChange(e)} autoComplete="off" />
              <label htmlFor="pl_designation">Designation</label>
              <span className="line"></span>
              {
           ...
           <div className="col-md-6">
            <div className="form-group">
              <input id="pl_company" type="text" className="form-control" name="company" value={company} required onChange={e => onChange(e)} autoComplete="off" />
              <label htmlFor="pl_company">Company Name<sup>*</sup></label>
              <span className="line"></span>
              {
          ...
          <div className="col-md-6">
            <div className="form-group">
              <input id="pl_industry" type="text" className="form-control" name="industry" value={industry}  onChange={e => onChange(e)} autoComplete="off" />
              <label htmlFor="pl_industry">Industry</label>
              <span className="line"></span>
              {
          ...
          <div className="col-md-6">
            <div className="form-group">
              <input id="pl_website" type="text" className="form-control" name="website" value={website}  onChange={e => onChange(e)} autoComplete="off" />
              <label htmlFor="pl_website">Website</label>
              <span className="line"></span>
              {
                  ...
                  <li className="w-50">
                    ...
                    <li className="w-50">
                        ...
                        <input type="radio" 
                          ...
                          value="8+ Weeks" 
                          onChange={e => onChange(e)} 
                          checked={pl_timeline === "8+ Weeks"} /> <span> 8+ Weeks</span></label>
                      </li>
              </ul>
              </div>
          ...
          <div className="col-md-6">
            <div className="form-group">
              <input id="pl_resume" name="filename" value={filename} type="text" className="form-control" onChange={(e) => onChangeFile(e)}/>
              {
              ...
              <label htmlFor="pl_resume">Upload BRD</label>
          ...
          <div className="col-md-6">
              <div className="form-group">
                <textarea id="pl_about" className="form-control" name="wish_message" value={wish_message} onChange={e => onChange(e)} autoComplete="off"></textarea>
                <label htmlFor="pl_about">Tells us about your project</label>
                <span className="line"></span>
                {
